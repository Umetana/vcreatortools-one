(function () {
  ...
  let templateId = pathParts[pathParts.length - 2] || 'view_comment_V3';
  ...
  const STORAGE_KEY = `vct.view-comment-v3.settings.${identity}`;
  const CHANNEL_NAME = `vct.view-comment-v3.channel.${identity}`;
